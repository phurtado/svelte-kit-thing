...
<div class="card" on:click={onClick} class:outer-show-front={side === 'front'}>
    <div class="inner-card" class:inner-show-front={side === 'front'}>
        {#if side === 'back'}
            <div>
...
<style>
    ...
    .card:hover:not(.outer-show-front) {
